...
import { PoolfilterVisibilityPage } from './components/AdminPages/PoolfilterVisibility';
import { UsersVisibilityPage } from './components/AdminPages/UsersVisibility';
import { CoalitionsPage } from './components/BasicPages/CoalitionsPage';
import { CampusPage } from './components/BasicPages/CampusPage';
import { TitlesPage } from './components/BasicPages/TitlesPage';
import { ProductsPage } from './components/BasicPages/ProductPage';
import { CursusPage } from './components/BasicPages/CursusPage';
import { GroupsPage } from './components/BasicPages/GroupsPage';
import { AchievementsPage } from './components/BasicPages/AchievementsPage';
import { TeamsPage } from './components/Projects/TeamsPage';
import { RulesPage } from './components/BasicPages/RulesPage';
import { ProjectsPage } from './components/BasicPages/ProjectsPage';
import { ProjectsVisibilityPage } from './components/AdminPages/ProjectsVisibility';
import { SettingsPage } from './components/Log/Settings';
import NotFoundPage from './components/GeneralPages/NotFoundPage';
import { UsersProfilesPage } from './components/AdminPages/UsersProfiles';
import { TinderPage } from './components/Projects/TinderPage';
import { UsersComputersPage } from './components/LocationsPages/UsersComputersPage';
import { UsersTotalPage } from './components/LocationsPages/UsersTotalPage';
import { ComputersTotalPage } from './components/LocationsPages/ComputersTotalPage';
import { PeaksDaysPage } from './components/LocationsPages/PeaksDaysPage';
import { UpdaterPage } from './components/AdminPages/Updater';
import { EventPage } from './components/Events/EventsPage';
import { LoveGraphPage } from './components/LocationsPages/LoveGraphPage';
import AboutPage from './components/GeneralPages/AboutPage';
import { PointsPage } from './components/BasicPages/PointsPage';
import { SingleProjectPage } from './components/BasicPages/SingleProjectsPage';
import { PersonalComputerView } from './components/LocationsPages/PersonalComputerView';
import { SubjectsPage } from './components/Projects/SubjectsPage';
import { UnmatchedSubjectsPage } from './components/Projects/UnmatchedSubjectsPage';
import TigPage from './components/Test/Tig';
import { PoolTableauPage } from './components/Tableau/PoolTableau';
import { FallGraphPage } from './components/FallPages/FallGraphPage';
import { SalesWatchPage } from './components/FallPages/SalesWatchPage';
import { OffersPage } from './components/BasicPages/OffersPage';
import { RushesPage } from './components/Projects/RushesPage';
import { InternshipsPage } from './components/Projects/InternshipsPage';
import { CalculatorPage } from './components/Projects/Calculator';
import { PacePage } from './components/Projects/Pace';
