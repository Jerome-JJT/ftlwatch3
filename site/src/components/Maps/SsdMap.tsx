...
export default function SsdMap({ id, deco, defaultColor = '#e5e5e5' }: MapProps) {
  ...
  return (
    <svg viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
      <g id="row1-0">
        <rect id={`${id}-c3r1s5`} height="20" width="16" y="40" x="60" stroke="#7f7f7f" fill={`${defaultColor}`}/>
        ...
        <rect id={`${id}-c3r1s4`} height="20" width="16" y="24" x="76" stroke="#7f7f7f" fill={`${defaultColor}`}/>
        ...
        <rect id={`${id}-c3r1s3`} height="20" width="16" y="40" x="92" stroke="#7f7f7f" fill={`${defaultColor}`}/>
        ...
        <rect id={`${id}-c3r1s2`} height="20" width="16" y="24" x="108" stroke="#7f7f7f" fill={`${defaultColor}`}/>
        ...
        <rect id={`${id}-c3r1s1`} height="20" width="16" y="40" x="124" stroke="#7f7f7f" fill={`${defaultColor}`}/>
      ...
      <g id="row2-0">
        <rect id={`${id}-c3r2s5`} height="20" width="16" y="100" x="60" stroke="#7f7f7f" fill={`${defaultColor}`}/>
        ...
        <rect id={`${id}-c3r2s4`} height="20" width="16" y="84" x="76" stroke="#7f7f7f" fill={`${defaultColor}`}/>
        ...
        <rect id={`${id}-c3r2s3`} height="20" width="16" y="100" x="92" stroke="#7f7f7f" fill={`${defaultColor}`}/>
        ...
        <rect id={`${id}-c3r2s2`} height="20" width="16" y="84" x="108" stroke="#7f7f7f" fill={`${defaultColor}`}/>
        ...
        <rect id={`${id}-c3r2s1`} height="20" width="16" y="100" x="124" stroke="#7f7f7f" fill={`${defaultColor}`}/>
      ...
      <g id="row3-0">
        <rect id={`${id}-c3r3s5`} height="20" width="16" y="160" x="60" stroke="#7f7f7f" fill={`${defaultColor}`}/>
        ...
        <rect id={`${id}-c3r3s4`} height="20" width="16" y="144" x="76" stroke="#7f7f7f" fill={`${defaultColor}`}/>
        ...
        <rect id={`${id}-c3r3s3`} height="20" width="16" y="160" x="92" stroke="#7f7f7f" fill={`${defaultColor}`}/>
        ...
        <rect id={`${id}-c3r3s2`} height="20" width="16" y="144" x="108" stroke="#7f7f7f" fill={`${defaultColor}`}/>
        ...
        <rect id={`${id}-c3r3s1`} height="20" width="16" y="160" x="124" stroke="#7f7f7f" fill={`${defaultColor}`}/>
      ...
      <g id="row4-0">
        <rect id={`${id}-c3r4s5`} height="20" width="16" y="220" x="60" stroke="#7f7f7f" fill={`${defaultColor}`}/>
        ...
        <rect id={`${id}-c3r4s4`} height="20" width="16" y="204" x="76" stroke="#7f7f7f" fill={`${defaultColor}`}/>
        ...
        <rect id={`${id}-c3r4s3`} height="20" width="16" y="220" x="92" stroke="#7f7f7f" fill={`${defaultColor}`}/>
        ...
        <rect id={`${id}-c3r4s2`} height="20" width="16" y="204" x="108" stroke="#7f7f7f" fill={`${defaultColor}`}/>
        ...
        <rect id={`${id}-c3r4s1`} height="20" width="16" y="220" x="124" stroke="#7f7f7f" fill={`${defaultColor}`}/>
      ...
      <g id="row5-0">
        <rect id={`${id}-c3r5s5`} height="20" width="16" y="280" x="60" stroke="#7f7f7f" fill={`${defaultColor}`}/>
        ...
        <rect id={`${id}-c3r5s4`} height="20" width="16" y="264" x="76" stroke="#7f7f7f" fill={`${defaultColor}`}/>
        ...
        <rect id={`${id}-c3r5s3`} height="20" width="16" y="280" x="92" stroke="#7f7f7f" fill={`${defaultColor}`}/>
        ...
        <rect id={`${id}-c3r5s2`} height="20" width="16" y="264" x="108" stroke="#7f7f7f" fill={`${defaultColor}`}/>
        ...
        <rect id={`${id}-c3r5s1`} height="20" width="16" y="280" x="124" stroke="#7f7f7f" fill={`${defaultColor}`}/>
      ...
      <g id="row6-0">
        <rect id={`${id}-c3r6s5`} height="20" width="16" y="340" x="60" stroke="#7f7f7f" fill={`${defaultColor}`}/>
        ...
        <rect id={`${id}-c3r6s4`} height="20" width="16" y="324" x="76" stroke="#7f7f7f" fill={`${defaultColor}`}/>
        ...
        <rect id={`${id}-c3r6s3`} height="20" width="16" y="340" x="92" stroke="#7f7f7f" fill={`${defaultColor}`}/>
        ...
        <rect id={`${id}-c3r6s2`} height="20" width="16" y="324" x="108" stroke="#7f7f7f" fill={`${defaultColor}`}/>
        ...
        <rect id={`${id}-c3r6s1`} height="20" width="16" y="340" x="124" stroke="#7f7f7f" fill={`${defaultColor}`}/>
